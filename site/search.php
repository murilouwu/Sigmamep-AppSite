	 	...
	 	<form class="pesquisa" method="post">
	 		<div class="bars">
	 			<div class="barA">
	 				...
	 				<i class="fa-solid fa-bars IMenu"></i>
	 			</div>
	 			<div class="barB">
	 		...
	 		<div class="checks">
	 			<div class="botons">
	 				<button class="btnCheck" onclick="altClass(this, ['btnCheck', 'btnAtv'], ['btnCheck'])"><i class="fa-solid fa-magnifying-glass IBtn"></i></button>
	 				<button class="btnCheck" onclick="altClass(this, ['btnCheck', 'btnAtv'], ['btnCheck'])"><i class="fa-solid fa-magnifying-glass IBtn"></i></button>
	 			</div>
